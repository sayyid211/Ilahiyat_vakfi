        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <span className="text-2xl font-bold text-white tracking-tight">Elazığ İlahiyat ve Harput İlim Vakfı</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/dua-ve-bedduasi" className="hover:text-white transition-colors">Dua Ve Bedduası</Link></li>
              <li><Link href="/bagis" className="hover:text-white transition-colors">Bağış</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="#" className="hover:text-white transition-colors">FÜ Gençlik Merkezi</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/profile.php?id=61568446975754#" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors"><FaFacebook className="h-6 w-6" /></a>

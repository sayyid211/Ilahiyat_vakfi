      ...
      <section className="bg-slate-50 dark:bg-background py-16">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-rose-900 rounded-2xl p-8 text-white shadow-lg hover:shadow-xl transition-shadow flex flex-col">
              ...
              <div className="flex items-center space-x-6 mt-auto">
                {/* X (Twitter) Logo */}
                <Link href="https://x.com/harputilimvakfi" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/10 hover:bg-white/20 rounded-full transition-colors">
                ...
                {/* Instagram Logo */}
                <Link href="https://www.instagram.com/elazigharputilimvakfi/" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/10 hover:bg-white/20 rounded-full transition-colors">
                  <svg className="w-6 h-6 fill-white" viewBox="0 0 24 24">
                ...
                {/* YouTube Logo */}
                <Link href="https://www.youtube.com/@ilahiyatvakfi23" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/10 hover:bg-white/20 rounded-full transition-colors">
                  <svg className="w-6 h-6 fill-white" viewBox="0 0 24 24">
          ...
          <div id="harita" className="mt-16 rounded-2xl overflow-hidden shadow-xl border border-slate-200 dark:border-slate-800">
            ...
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2818.843043016171!2d39.216210675394315!3d38.67363855987677!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4076c06f92707945%3A0x174fbaec91f7d2f5!2zRWxhesSxxJ8gxLBsYWhpeWF0IFZlIEhhcnB1dCDEsGxpbSBWYWtmxLEgw5bEn3JlbmNpIFl1cmR1!5e1!3m2!1sen!2str!4v1788863915527!5m2!1sen!2str"
              width="100%" 
              height="450" 
              style={{ border: 0 }} 
